   ...
   <style>
      * {
      ...
      body {
         ...
         height: 100vh;
         overflow: hidden;
         background: linear-gradient(to right, rgb(242, 255, 254), rgb(77, 255, 240));
      }
      ...
      .logo span {
         ...
         text-shadow: 0 0 10px rgb(224, 66, 245);
      }
      ...
      .content .typewriter span {
         color: rgb(224, 66, 245);
         font-size: 2.5rem;
         text-shadow: 0 0 5px rgb(224, 66, 245);
         position: relative;
         transition: 0.3s linear;
      }

      .typewriter span::before {
         content: "Pursuing Diploma";
      ...
      .content button:hover {
         scale: 1.1;
         color: rgb(49, 49, 112);
         border: 2px solid rgb(49, 49, 112);
         background-color: transparent;
         font-weight: 700;
         box-shadow: 0 0 40px rgb(49, 49, 112);
      }
...
<body>
   ...
   <section>
      <div class="main-container">
         ...
         <div class="content">
            <h1 data-aos="fade-left" data-aos-duration="1000" data-aos-delay="800">Hey I'm <span>Vikash</span></h1>
            ...
            <p data-aos="flip-up" data-aos-duration="1000" data-aos-delay="1000">
               Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione, perferendis quas consectetur possimus maxime consequatur cupiditate eos dolorum molestias praesentium error exercitationem rem labore illo, in dolor, odio corporis excepturi?</p>
